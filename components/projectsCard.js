...
const ProjectsCard = (props) => {
  const { name, desc, image, skills, github, status,width,height,ml} = props;
  ...
  return (
    <div className="project-card mb-7 text-stark w-fit flex  items-center ">
      <div className="project-description  rounded-2xl py-2 ">
        ...
        {
          status ==="completed" && <span><Image src="/images/checked.png" width={16} height={16}/></span>
        }
        {
          status ==="ongoing" && <span><Image src="/images/cycle.png" width={16} height={16}/></span>
        }
